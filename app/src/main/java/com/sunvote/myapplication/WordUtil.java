...
public class WordUtil {
    ...
    private String tableBegin = "<table style=\"border-collapse:collapse\" border=1 " +
            "bordercolor=\"black\">";
    ...
    public WordUtil(String doc_name) {
        docPath = doc_name;
        htmlPath = FileUtil.createFile(".html", "test");
...
//                            if (isRegion == true) {
//                                int size = getSize(Integer.valueOf(xmlParser.getAttributeValue
//                                (0)));
...
////                            if (pic_entry != null) {
////                                byte[] pictureBytes = FileUtil.getPictureBytes(docxFile,
// pic_entry);
...
//        picturePath = FileUtil.createFile("html",
//                FileUtil.getFileName(docPath) + presentPicture + ".jpg");
            ...
            if (run.getPicOffset() == 0 || run.getPicOffset() >= 1000) {
                ...
                try {
                    ...
                    if (text.length() >= 2 && pnumCharacterRuns < 2) {
                        ...
                        String fontSizeBegin = String.format(fontSizeTag,
                                getSize(run.getFontSize()));
                        String fontColorBegin = String.format(fontColorTag,
                                getColor(run.getColor()));
